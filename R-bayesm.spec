...
Version  : 3.1.3
Release  : 28
URL      : https://cran.r-project.org/src/contrib/bayesm_3.1-3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/bayesm_3.1-3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1564517407
